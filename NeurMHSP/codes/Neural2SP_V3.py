...
def data_load(directory_path, file_pattern, size1, size2):
...
def data_split(data):
    ...
    return X_train_tensor, y_train_tensor, feasibility_train_tensor, X_test_tensor, y_test_tensor, feasibility_test_tensor, train_data, train_loader
...
def train_model(best,data):
    ...
    X_train_tensor, y_train_tensor, feasibility_train_tensor, X_test_tensor, y_test_tensor, feasibility_test_tensor, train_data, train_loader = data_split(data)
...
def result_plot(model_directory, plot_filename, size1, size2, actual, predicted):
...
for size in problem_sizes:
    ...
    for i in range(num_data_size):
        ...
        data = data_load(directory_path, file_pattern, size1, size2)
        X_train_tensor, y_train_tensor, feasibility_train_tensor, X_test_tensor, y_test_tensor, feasibility_test_tensor, train_data, train_loader = data_split(data)
        ...
        a = result_plot(model_directory, plot_filename, size1, size2, actual, predicted)
