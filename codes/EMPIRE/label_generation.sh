...
#SBATCH --mem=32GB          
#SBATCH --time=4:00:00            # Adjusted time based on expected workload
#SBATCH --account=azs7266_sc
#SBATCH --partition=sla-prio
#SBATCH --array=1-2000%15     #일단 1000개만
...
TASK_ID=$((${SLURM_ARRAY_TASK_ID}+3000))   # file num
OPERATIONS_PER_TASK=8
TOTAL_OPERATIONS=80000 # 80000
...
/storage/home/tzk5446/.conda/envs/neurmhsp/bin/python label_generation.py \
    --task_id $TASK_ID \
