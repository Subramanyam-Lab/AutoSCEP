...
def run_experiment(seed):
    ...
    # Run the model
    input_vector, expected_second_stage_value = run_empire(
        name=name,
        tab_file_path=tab_file_path,
...
def main():
    ...
    parser.add_argument('--seed', type=int, required=True, help='Seed value for the experiment')
