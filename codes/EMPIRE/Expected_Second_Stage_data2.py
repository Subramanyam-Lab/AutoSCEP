...
def run_second_stage(name, tab_file_path, result_file_path, scenariogeneration, scenario_data_path,
    ...
    if hour_decision:
        ...
        scenariopath = f"Data handler/scenarios/file_{file_num}/{seed}"
...
#        f.close()
    ...
    ll_amt = lost_load_amt(instance)
    
    VOLL = 22000
    validate_second_stage_value = obj_value + (VOLL - 1e+8) * ll_amt

    
    return first_stage_value, validate_second_stage_value, v_dict 
