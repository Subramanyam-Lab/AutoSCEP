...
#SBATCH --array=1401-2000%10       # 4,000 array tasks with 400 concurrent
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=10
#SBATCH --mem=64GB          
#SBATCH --time=24:00:00            # Adjusted time based on expected workload
...
/storage/home/tzk5446/.conda/envs/neurmhsp/bin/python Data_generation_run4.py \
    --task_id $TASK_ID \
