...
# How many First-Stage Decision samples will reference
# How many problem will solve
num_fsd = 10
...
# When we solve the empire with 'num_fsd' times, 
# The number of references for samples is 'num_fsd'
# All of the samples are saved in 'FSD' directory.
# Following code is execeuted sampling.py which is sampling feasible
# first stage solutions based on the all of files in 'FSD' directory.
subprocess.run(['python', 'sampling.py'])