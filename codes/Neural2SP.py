...
for size in problem_sizes:
    ...
    for i in range(3):
        ...
        if base_directory_path == "results4":
        ...
        # mean = data['expected second stage value'].mean()
        # std = data['expected second stage value'].std()
        # data['expected second stage value'] = (data['expected second stage value'] - mean) / std
        
        # Filter out rows where 'expected second stage value' exceeds the threshold
        data = data[data['expected second stage value'] <= value_threshold]
        ...
        # Define model with added complexity
